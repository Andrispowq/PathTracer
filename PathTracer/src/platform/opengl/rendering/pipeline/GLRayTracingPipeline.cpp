...
#include "GLRayTracingPipeline.h"

namespace Prehistoric
{
	GLRayTracingPipeline::GLRayTracingPipeline(Window* window, AssetManager* manager, ShaderHandle shader)
		: GLPipeline(window, manager, shader), RayTracingPipeline()
	{
	}

	void GLRayTracingPipeline::BindPipeline(CommandBuffer* buffer) const
	{
	...
	void GLRayTracingPipeline::RenderPipeline() const
	{
	...
	void GLRayTracingPipeline::UnbindPipeline() const
	{
